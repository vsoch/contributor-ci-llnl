...
function draw_line_repo_star_history(areaID, repoNameWOwner) {

    // load data file, process data, and draw visualization
    var url0 = '{{ site.baseurl }}/{{ site.cci_data }}/cci-stars.json';
    var url1 = '{{ site.baseurl }}/{{ site.cci_data }}/cci-releases.json';
    var files = [url0, url1];
